defmodule ExJsonSchema.Schema.Draft6 do
  ...
  "properties" => %{
    ...
    "items" => %{"anyOf" => [%{"$ref" => "#"},
        %{"$ref" => "#/definitions/schemaArray"}], "default" => %{}},
    ...
    "minimum" => %{"type" => "number"},
    "multipleOf" => %{"exclusiveMinimum" => true, "minimum" => 0,
      "type" => "number"}, "not" => %{"$ref" => "#"},
    ...
    "type" => %{"anyOf" => [%{"$ref" => "#/definitions/simpleTypes"},
        %{"items" => %{"$ref" => "#/definitions/simpleTypes"}, "minItems" => 1,
          "type" => "array", "uniqueItems" => true}]},
