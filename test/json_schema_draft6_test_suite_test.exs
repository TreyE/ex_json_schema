defmodule ExJsonSchema.JsonSchemaDraft6TestSuiteTest.Helpers do
...
defmodule ExJsonSchema.JsonSchemaDraft6TestSuiteTest do
  ...
  import ExJsonSchema.JsonSchemaDraft6TestSuiteTest.Helpers
  ...
  Enum.each @tests, fn feature ->
    ...
    Enum.each fixture, fn fixture ->
      ...
      @schema (case Kernel.is_map(schema) do
          false -> schema
          true -> Map.put_new(schema, "$schema", "http://json-schema.org/draft-06/schema#")
        end)
